...
function inicio(){
    ...
    let musicaOn = document.getElementById("yesmusic");
    musicaOn.addEventListener("click", apagarMusica);
    let musicaOff = document.getElementById("nomusic");
    musicaOff.addEventListener("click", encenderMusica);
