...
function inicio() {
    ...
    botonSonido.addEventListener("click", (Event) => { musica(); })
}
...
function jugada(valorTirada, jugadorActual) {
    ...
    } else if ((pucheros[valorTirada].casillaActual + 1 < pucheros[valorTirada].casillaMax) && (jugadores[jugadorActual].tokens != 0)) {
